    ...
    <main className="px-4 md:px-0">
      <section className="pb-14 border-b border-slate-300 mb-14">
        ...
        <p className="text-slate-700 text-lg md:text-xl leading-normal">
          Full-stack Software Engineer II @ CBRE, building global-scale applications for millions. I craft robust, scalable systems with seamless user experiences.
        </p>
        <Link
          href="/info"
